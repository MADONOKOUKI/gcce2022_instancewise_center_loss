...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=2, drop_rate=0.0):
        ...
        self.fc2 = nn.Linear(n_channels[3], num_classes)
        self.fc2_sep = nn.Linear(n_channels[3], num_classes)
    ...
    def forward(self, x):
        ...
        out = out2.view(-1, self.nChannels)
        # print(out.shape, out2.shape)
        return self.fc(out) , out2
